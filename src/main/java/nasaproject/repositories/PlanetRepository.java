package nasaproject.repositories;
...
* Każdą adnotację da się zastąpić @Component
*
* */
...
public interface PlanetRepository extends JpaRepository<Planet, Long> {
    ...
    // @Query("select * from planets where planet_name = ?1", nativeQuery = true) // SQL - drugi sposób oparty na SQLu
